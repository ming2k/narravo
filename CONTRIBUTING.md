...
- **English is the official working language of this project.**
- All code (variable names, functions, comments), commit messages, documentation, and communications (issues, pull requests) must be in English.
- This ensures the project remains accessible and maintainable for a global audience.
...
Found a bug? Please [open an issue](https://github.com/mingsterism/narravo/issues) with:
...
Thank you for contributing to Narravo!